...
export default function HomePage() {
  const [wallet, setWallet] = useState("test123");
  const [loadedWallet, setLoadedWallet] = useState("test123");
  ...
  async function loadProfile(targetWallet?: string) {
    const finalWallet = (targetWallet || wallet).trim();

    if (!finalWallet) {
      setStatus("Please enter a wallet first");
      return;
    }
        ...
        >
          <div style={{ display: "grid", gap: 20 }}>
            <section style={leftCard}>
              ...
              <input
                ...
                style={inputStyle}
              />
              <button style={primaryButton} onClick={() => loadProfile(wallet)}>
                Load Profile
              </button>
            ...
            <section style={leftCard}>
              ...
              <div style={{ display: "grid", gap: 10 }}>
                ...
                />
                <RewardRow
                  label="Total next reward"
                  value={`${formatNumber(totalPreviewReward)} KPY`}
                  strong
                />
              </div>
          ...
          <div style={{ display: "grid", gap: 20 }}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <InfoChip
                      label="Current XP"
                      value={`${formatNumber(miningProgress.currentXp)}`}
                    />
                    <InfoChip
                      label="Next Level"
                      value={
                  ...
                  <div style={{ marginTop: 14, color: "#8fa4c4", fontSize: 13 }}>
                    {miningProgress.nextLevel
                      ? `Keep mining and completing tasks to reach level ${miningProgress.nextLevel}.`
                      : "You reached the current top level."}
                  </div>
                </div>
              </div>
            </section>
            ...
            <section style={rightCard}>
              ...
              >
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <TabButton
                    active={leaderboardType === "mined"}
                    onClick={() => setLeaderboardType("mined")}
                  >
                    Mined
                  </TabButton>
                  <TabButton
                  ...
                  <TabButton
                    active={leaderboardType === "referrals"}
            ...
            <section style={rightCard}>
              ...
              {lastClaimAt ? (
                <div style={{ marginTop: 12, color: "#7f93b1", fontSize: 13 }}>
                  Last claim timestamp: {lastClaimAt}
                </div>
              ) : null}
            </section>
          </div>
